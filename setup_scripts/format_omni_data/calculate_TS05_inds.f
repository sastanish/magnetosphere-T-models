...
c
      ...
      CHARACTER*80 SWNAME,NAMEOUT,LISTNAME,STORMNAME
     ...
     * IMFFLAG(105408),ISWFLAG(105408)
      ...
      SWNAME='./data/omni_data_'//trim(adjustl(STORMNAME))//
     & '_filled_gaps_with_tilt.lst'
      NAMEOUT='./data/'//trim(adjustl(STORMNAME))//
     & '_TS05_parameters.lst'
C
...
C
 ...
 1    READ(1,444) IYEA,IDA,IHOU,MI,BX,
     * BY,BZ,VX,VY,VZ,DEN,
     * T,PA,AeIND,DST5M,IMFLAG,SWFLAG,
     * TILT,Pdyn
...
C
      OPEN (UNIT=1,FILE="intervals.txt")
      NREC1=0
...
C    CALCULATE W1 - W6 INDICES:
 ...
 545  FORMAT(2I4,2I3,3F8.2,3F8.1,F7.2,F9.0,F6.2,2I6,2I3,F8.4,F7.2)
      WRITE(3,545) IYEA,IDAY(IND),IHOUR(IND),MIN(IND),BXGSM(IND),
