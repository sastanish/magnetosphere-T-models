...
infiles = ['2018-08-25.lst', '2022-03-13.lst', '2023-03-22.lst', '2024-03-03.lst', '2024-08-11.lst', '2021-11-03.lst', '2022-10-22.lst', '2023-04-23.lst', '2024-03-24.lst', '2024-10-10.lst', '2022-01-14.lst', '2023-02-26.lst', '2023-11-06.lst', '2024-05-10.lst']
...
for infile in infiles:
    ...
    with open('data/' + infile[0:-4] + "_filled_gaps.lst","w") as out_file:
